...
SWEP.UseHands					= true
	...
	-- NPC Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.NPC_NextPrimaryFire 		= math.random(0.45,0.65) -- Next time it can use primary fire
...
SWEP.Primary.Delay				= 0.35 -- Time until it can shoot again
...
SWEP.NextIdle_PrimaryAttack		= math.random(0.30,0.40) -- How much time until it plays the idle animation after attacking(Primary)
