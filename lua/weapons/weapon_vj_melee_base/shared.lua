...
SWEP.PrintName					= "VJ Melee Weapon Base"
SWEP.Author 					= "Comrade Communiat"
...
self.Owner.HasRunFromEnemy = false
self.Owner.LatestEnemyDistance = 50000
self.Owner.MeleeAttackDistance = 15
self.Owner.CanCrouchOnWeaponAttack = false
self.Owner.DisableWeaponFiringGesture = true
self.Owner.AllowWeaponReloading = false
self.Owner.MoveOrHideOnDamageByEnemy_OnlyMove = true
self.Owner.MoveRandomlyWhenShooting = false
self.Owner.WaitForEnemyToComeOut = false
self.Owner.WeaponSpread = 1
self.Owner.CallForBackUpOnDamage = false
self.Owner.DropWeaponOnDeath = false
self.Owner.DistanceToRunFromEnemy = 30
self.Owner.NextMeleeAttackTime = 0
self.Owner.AnimTbl_IdleStand = {ACT_IDLE}
self.Owner.MeleeAttackBleedEnemy = true
self.Owner.AnimTbl_Run = {ACT_RUN}
self.Owner.AnimTbl_Walk = {ACT_WALK}
self.Owner.HasGrenadeAttack = false
self.Owner.RunAwayOnUnknownDamage = false
self.Owner.MoveOrHideOnDamageByEnemy = false
--self.Owner.DisableSelectSchedule = true
self.Owner.RunFromEnemy_Distance = 0
self.NPC_FiringDistanceMax = 1
self.Owner.HasShootWhileMoving = false
self.Owner.Weapon_FiringDistanceFar = 0 -- How far away it can shoot
self.Owner.Weapon_FiringDistanceClose = 0 
self.Owner.ShootDistance = 1
