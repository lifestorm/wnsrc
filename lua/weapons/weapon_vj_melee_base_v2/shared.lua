...
SWEP.Author = "DrVrej and Comrade Communist"
SWEP.Contact = "http://steamcommunity.com/groups/vrejgaming"
SWEP.Purpose = "This weapon is made for Players and NPCs"
SWEP.Instructions = "Controls are like a regular weapon."
SWEP.Category = "VJ Melee Base"
...
SWEP.NPC_FiringDistanceMax = 100000 -- Maximum firing distance | Clamped at the maximum sight distance of the NPC
	-- ====== Reload Variables ====== --
SWEP.NPC_HasReloadSound = false -- Should it play a sound when the base detects the SNPC playing a reload animation?
...
SWEP.NPC_HasSecondaryFireSound = false -- Can the secondary fire sound be played?
