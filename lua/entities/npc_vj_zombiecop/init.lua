...
-----------------------------------------------*/
ENT.Model = {"models/opfor/zombie_barney.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("npc_vj_zombiecop_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_zombiecop_d")
