...
-----------------------------------------------*/
ENT.Model = {"models/ports/zombie_construction.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("npc_vj_toxiczombie_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_toxiczombie_d")
ENT.FootStepTimeRun = 0.4 -- Next foot step sound when it is running
ENT.FootStepTimeWalk = 0.4 -- Next foot step sound when it is walking
ENT.HasExtraMeleeAttackSounds = true -- Set to true to use the extra melee attack sounds
ENT.HasRangeAttack = true -- Should the SNPC have a range attack?
ENT.AnimTbl_RangeAttack = {"vjseq_Attack2"} -- Range Attack Animations
