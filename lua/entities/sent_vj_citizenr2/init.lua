...
ENT.EntitiesToSpawn = {
	...
	{EntityName = "NPC1",SpawnPosition = {vForward=0,vRight=0,vUp=0},Entities = {"npc_vj_hl2_Citizen2","npc_vj_hl2_Citizen4"}}--,WeaponsList = {"weapon_vj_crowbar", "weapon_vj_pistol_hl2", "weapon_vj_smg1_hl2"}},
}
