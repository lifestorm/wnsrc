...
-----------------------------------------------*/
ENT.Model = {"models/ports/zombie_burnt.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("npc_vj_zombieflame_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_zombieflame_d")
