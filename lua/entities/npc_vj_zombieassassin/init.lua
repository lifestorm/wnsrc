...
-----------------------------------------------*/
ENT.Model = {"models/ports/zombie_assassin.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("npc_vj_zombieassassin_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_zombieassassin_d")
