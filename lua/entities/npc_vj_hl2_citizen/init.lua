...
ENT.IdleDialogueSoundPitch = VJ_Set(100, 100)
ENT.IdleDialogueAnswerSoundPitch = VJ_Set(100, 100)
ENT.CombatIdleSoundPitch = VJ_Set(100, 100)
ENT.OnReceiveOrderSoundPitch = VJ_Set(100, 100)
ENT.FollowPlayerPitch = VJ_Set(100, 100)
ENT.UnFollowPlayerPitch = VJ_Set(100, 100)
ENT.MoveOutOfPlayersWaySoundPitch = VJ_Set(100, 100)
ENT.BeforeHealSoundPitch = VJ_Set(100, 100)
ENT.AfterHealSoundPitch = VJ_Set(100, 100)
ENT.MedicReceiveHealSoundPitch = VJ_Set(100, 100)
ENT.OnPlayerSightSoundPitch = VJ_Set(100, 100)
ENT.InvestigateSoundPitch = VJ_Set(100, 100)
ENT.LostEnemySoundPitch = VJ_Set(100, 100)
ENT.AlertSoundPitch = VJ_Set(100, 100)
ENT.CallForHelpSoundPitch = VJ_Set(100, 100)
ENT.BecomeEnemyToPlayerPitch = VJ_Set(100, 100)
ENT.BeforeMeleeAttackSoundPitch = VJ_Set(100, 100)
ENT.MeleeAttackSoundPitch = VJ_Set(100, 100)
ENT.ExtraMeleeSoundPitch = VJ_Set(100, 100)
ENT.MeleeAttackMissSoundPitch = VJ_Set(90, 100)
ENT.SuppressingPitch = VJ_Set(100, 100)
ENT.WeaponReloadSoundPitch = VJ_Set(100, 100)
ENT.GrenadeAttackSoundPitch = VJ_Set(100, 100)
ENT.OnGrenadeSightSoundPitch = VJ_Set(100, 100)
ENT.OnDangerSightSoundPitch = VJ_Set(100, 100)
ENT.OnKilledEnemySoundPitch = VJ_Set(100, 100)
ENT.AllyDeathSoundPitch = VJ_Set(100, 100)
ENT.PainSoundPitch = VJ_Set(100, 100)
ENT.ImpactSoundPitch = VJ_Set(100, 100)
ENT.DamageByPlayerPitch = VJ_Set(100, 100)
