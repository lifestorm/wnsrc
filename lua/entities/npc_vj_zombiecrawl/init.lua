...
-----------------------------------------------*/
ENT.Model = {"models/zombiecrawl.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
ENT.AnimTbl_Death = {"limp_leg_die"} -- Death Animations
...
function ENT:MultipleMeleeAttacks()
    local randattack = math.random(1,3)
		...
		self.AnimTbl_MeleeAttack = {"vjseq_limp_leg_attack1"}
		self.MeleeAttackDamage = GetConVarNumber("npc_vj_zombiecrawl_d")
		...
		self.TimeUntilMeleeAttackDamage = 0.8
		self.MeleeAttackAnimationFaceEnemy = false
		self.AnimTbl_MeleeAttack = {"vjseq_limp_leg_attack2"}
		...
		self.MeleeAttackAnimationFaceEnemy = false
		self.AnimTbl_MeleeAttack = {"vjseq_limp_leg_attack3"}
		self.MeleeAttackExtraTimers = {} 
		self.MeleeAttackDamage = GetConVarNumber("npc_vj_zombiecrawl_d")
		self.MeleeAttackDamageDistance = 90
		self.MeleeAttackDamageType = DMG_SLASH
