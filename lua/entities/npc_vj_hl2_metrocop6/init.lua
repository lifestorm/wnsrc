...
ENT.Model = {"models/metrocop2.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 115
...
ENT.SquadName = "metrocopga" -- Squad name, console error will happen if two groups that are enemy and try to squad!
