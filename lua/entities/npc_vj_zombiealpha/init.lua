...
-----------------------------------------------*/
ENT.Model = {"models/hl1_alpha/zombie_uv.mdl","models/hl1_alpha/zombie.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth =  GetConVarNumber("npc_vj_zombiealpha_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_zombiealpha_d")
