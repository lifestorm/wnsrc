...
ENT.StartHealth = GetConVarNumber("npc_vj_zombiegrenade_h")
...
//ENT.NextAnyAttackTime_Melee = 0.9 -- How much time until it can use any attack again? | Counted in Seconds
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_zombiegrenade_d")
