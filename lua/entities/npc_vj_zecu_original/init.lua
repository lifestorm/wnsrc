...
-----------------------------------------------*/
ENT.Model = {"models/szombie/zombie_soldier1.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = GetConVarNumber("npc_vj_zecu_original_h")
...
ENT.MeleeAttackDamage = GetConVarNumber("npc_vj_zecu_original_d")
