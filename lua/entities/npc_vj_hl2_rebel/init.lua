...
ENT.NextThrowGrenadeTime1 = math.random(17,29) -- Time until it runs the throw grenade code again | The first # in math.random
ENT.NextThrowGrenadeTime2 = math.random(16,31) -- Time until it runs the throw grenade code again | The second # in math.random
