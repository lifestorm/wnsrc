...
ENT.WeaponSpread = 1
ENT.BloodColor = "Red" 
ENT.SightDistance = 5500 -- How far it can see
...
ENT.NextThrowGrenadeTime1 = math.random(17,28) -- Time until it runs the throw grenade code again | The first # in math.random
ENT.NextThrowGrenadeTime2 = math.random(11,30) -- Time until it runs the throw grenade code again | The second # in math.random
