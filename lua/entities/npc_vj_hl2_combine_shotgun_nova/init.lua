...
ENT.DistanceToRunFromEnemy = 150
ENT.MeleeAttackDamage = 45
ENT.SquadName = "combine_nova" -- Squad name, console error will happen if two groups that are enemy and try to squad!
...
ENT.NextThrowGrenadeTime1 = math.random(15,25) -- Time until it runs the throw grenade code again | The first # in math.random
ENT.NextThrowGrenadeTime2 = math.random(20,30) -- Time until it runs the throw grenade code again | The second # in math.random
