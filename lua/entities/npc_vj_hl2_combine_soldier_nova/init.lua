...
ENT.NextThrowGrenadeTime1 = math.random(8,17) -- Time until it runs the throw grenade code again | The first # in math.random
ENT.NextThrowGrenadeTime2 = math.random(5,25) -- Time until it runs the throw grenade code again | The second # in math.random
