...
function medialib.tryInclude(file)
	...
	if medialib.DEBUG then
		print("[MediaLib] Tentative d'inclusion d'un fichier inexistant " .. file)
	end
...
function medialib.load(name)
	...
	if medialib.DEBUG then
		print("[MediaLib] chargement d'un module non référencé " .. name)
	end
