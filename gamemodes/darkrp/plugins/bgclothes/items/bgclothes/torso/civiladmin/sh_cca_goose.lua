...
ITEM.name = "Golden Goose"
ITEM.description = "Ticaret Bakanlığı'ndaki bir grup çılgın deli tarafından bizzat tasarlanmıştır."
...
ITEM.proxy = {
ShirtColor = Vector(255 / 255, 250 / 255, 240 / 255),
TorsoColor = Vector(255 / 255, 215 / 255, 32 / 255),
}
ITEM.bodyGroups	=	{
		torso	=	34
}
