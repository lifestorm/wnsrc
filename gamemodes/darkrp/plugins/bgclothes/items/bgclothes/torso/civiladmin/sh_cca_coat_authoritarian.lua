...
ITEM.name = "Manteau de l'autoritaire"
ITEM.description = "Fabriqué à la main pour le climat genevois, en laine de première qualité et en fil fin."
...
ITEM.proxy = {
TorsoColor = Vector(30 / 255, 30 / 255, 30 / 255)
}
ITEM.bodyGroups	=	{
		torso	=	35
}