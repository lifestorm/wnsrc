...
ITEM.name = "Mulligan Ekspresi"
ITEM.description = "Mulligan'ın kendi kişisel favorilerinden biri."
...
ITEM.proxy = {
ShirtColor = Vector(244 / 255, 241 / 255, 244 / 255), -- lavender (matching)
TorsoColor = Vector(221 / 255, 127 / 255, 127 / 255), -- salmon pink
}
ITEM.colorAppendix	=	{
