...
ITEM.name = "Fil Avcısı"
ITEM.description = "Mevcut en iyi ipek malzemelerden yapılmış olan bu fildişi kompleks takım elbise nüfuz, otorite ve kontrolü sergiler."
