...
if (CLIENT) then
	function SWEP:DrawHUD()
		...
		draw.SimpleTextOutlined("Clique DROIT pour quitter", "DermaLarge", ScrW() / 2, ScrH()-200, Color(250,250,250), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 250))
	end
end
