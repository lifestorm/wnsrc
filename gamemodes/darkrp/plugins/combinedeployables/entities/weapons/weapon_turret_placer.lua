...
if (CLIENT) then
	function SWEP:DrawHUD()
		...
		if (!ply:Alive()) then return end
 		...
 		draw.SimpleTextOutlined("Clique GAUCHE pour poser", "DermaLarge", ScrW() / 2, ScrH()-230, Color(250,250,250), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 250))
		draw.SimpleTextOutlined("Clique DROIT pour pour quitter", "DermaLarge", ScrW() / 2, ScrH()-200, Color(250,250,250), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(25, 25, 25, 250))
	end
end
