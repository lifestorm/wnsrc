...
ix.lang.AddTable("english", {
	lethalGasEntered = "Il semble que quelque chose dans l'air pèse lourdement sur votre corps. Vous avez l'impression que vous ne devriez pas rester ici sans une protection adéquate.    ."
})