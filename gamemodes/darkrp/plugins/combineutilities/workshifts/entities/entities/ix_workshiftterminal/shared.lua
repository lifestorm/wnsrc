...
ENT.Displays = {
	...
	[3] = {"VARDIYA BASLADI", Color(0, 255, 0)},
	[4] = {"YENILENIYOR", Color(255, 200, 0)},
	[5] = {"KAPALI", Color(255, 0, 0), true},
	[6] = {"BASARILI", Color( 0, 255, 180 )},
	[7] = {"VARDIYA BITTI", Color(255, 0, 0)},
	[8] = {"BILGI YOK", Color(0, 255, 0)},
	[9] = {"VARDIYA KAPALI", Color(255, 0, 0)},
	[10] = {"ZATEN KATILDI", Color(255, 0, 0)},
	[11] = {"KAYIT DURAKLATILDI", Color(255, 0, 0)}
}
