...
function ENT:Draw()
    ...
    cam.Start3D2D(position + forward + trueR + thisU, angles, 0.25 * (self.small and smallScale or self.tv and tvScale or 1))
        ...
        draw.DrawText( "SOSYAL STABİLİTE", "CombineMonitorLarge", w / 2 - (self.tv and 50 or 25), -30, Color( 255, 255, 255, alpha ), TEXT_ALIGN_LEFT )
        ...
        draw.DrawText( "VARDİYA DURUMU", "CombineMonitorLarge", w / 2 - (self.tv and 50 or 25), 80, Color( 255, 255, 255, alpha ), TEXT_ALIGN_LEFT )
    ...
    if (halo.RenderedEntity() != self) then
        ...
        cam.Start3D2D(position + forward + thisR2 + thisU2, angles, 0.25 * (self.small and smallScale or self.tv and tvScale or 1))
            PLUGIN.clip:Scissor2D(w * 4.3, h * 2)
                draw.DrawText( "DUYURULAR", "CombineMonitorLarge", w / 2, 5, Color( 255, 255, 255, alpha ), TEXT_ALIGN_LEFT )
