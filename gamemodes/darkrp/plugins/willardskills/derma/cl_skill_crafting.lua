...
function PANEL:Init()
	...
	-- Config
	self.firstTitle = "Tarifler"
	self.secondTitle = "Üretim"
	self.thirdTitle = "Önizleme"
	self.nothingSelected = "Hiçbir ürün/tarif seçilmedi"
	self.requirementsTitleText = "Gereksinimleri: "
	self.ingredientsTitleText = "Malzemeler:"
	self.skill = "crafting"
