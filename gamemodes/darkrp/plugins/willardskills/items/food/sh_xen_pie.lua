...
ITEM.name = "Xenian Turta"
ITEM.description = "Diğer dünyalara ait malzemeler sıcak bir turtaya dönüşmek için karıştırıldı. Bunu ancak usta bir şef başarabilir."
ITEM.category = "Xen"
