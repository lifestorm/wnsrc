...
ITEM.name = "Tarte xénienne"
ITEM.description = "Des ingrédients d'un autre monde mélangés pour devenir une tarte chaude. Seul un maître cuisinier pourrait y parvenir."
ITEM.category = "Xen"
