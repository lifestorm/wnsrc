...
ITEM.name = "Üretim Tezgahı Montaj Kiti"
ITEM.description = "Bu ahşap paket, bir dizi talimatın yanı sıra, Üretim aparatı için çok sayıda farklı bileşen parçası içerir."
ITEM.category = "Tools"
ITEM.width = 3
ITEM.height = 3
