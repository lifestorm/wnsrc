...
ITEM.description = "En plus d’un ensemble d’instructions, cette caisse en bois contient une inscription avec les différents composants pour construire une table à dames."
