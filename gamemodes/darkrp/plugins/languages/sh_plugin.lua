...
ix.lang.AddTable("english", {
    optLanguageFlagsEnabled = "Activer les indicateurs de langue",
    optdLanguageFlagsEnabled = "Activer les icônes de chat pour indiquer la langue dans laquelle quelque chose est parlé pour le texte IC en langue non anglaise."
})
...
do
    -- Danish
    local language = ix.languages:New()
    language.name = "Danois"
    language.uniqueID = "danois"
...
do
    -- Japanese
    local language = ix.languages:New()
    language.name = "Japonais"
    language.uniqueID = "japonais"
...
do
    ...
    local language = ix.languages:New()
    language.name = "Coréen"
    language.uniqueID = "coréen"
...
do
    -- Chinese
    local language = ix.languages:New()
    language.name = "Chinois"
    language.uniqueID = "chinois"
...
do
    -- Bulgarian
    local language = ix.languages:New()
    language.name = "Bulgare"
    language.uniqueID = "bulgare"
...
do
    -- German
    local language = ix.languages:New()
    language.name = "Allemand"
    language.uniqueID = "allemand"
...
do
    ...
    language.uniqueID = "english"
    language.icon = "flags16/gb.png"
    language.gibberish = {"plenary", "yesterday", "patpat", "charge", "eighth", "day", "arm", "commerce", "aspiration", "sadly", "petrol", "succeed", "walk", "talent", "verification",
    "laugh", "taxpayer", "probably", "different", "research", "efficient", "also", "dominate", "radio", "occur", "naval", "governor", "raise", "old", "tear",
    "amendment", "satisfactory", "motif", "wish", "operator", "mail", "conservation", "formality", "area", "augmentation", "late", "vague", "boast", "destroy", "boast", "need",
    "grant", "done", "founded", "ten", "software", "surgeon", "confused", "terminal", "bathe", "restructuring", "settlement", "rain", "twenty-four", "believer", "orientation"}
...
do
    -- Italian
    local language = ix.languages:New()
    language.name = "Italien"
    language.uniqueID = "italien"
...
do
    -- Dutch
    local language = ix.languages:New()
    language.name = "Néerlandais"
    language.uniqueID = "néerlandais"
...
do
    -- Finnish
    local language = ix.languages:New()
    language.name = "Finois"
    language.uniqueID = "finois"
...
do
    -- Swedish
    local language = ix.languages:New()
    language.name = "Suédois"
    language.uniqueID = "suédois"
...
do
    -- Hindi
    local language = ix.languages:New()
    language.name = "Hindie"
    language.uniqueID = "hindie"
...
do
    -- Croatian
    local language = ix.languages:New()
    language.name = "Croate"
    language.uniqueID = "croate"
    language.icon = "icon16/world.png"
...
do
    -- Turkish
    local language = ix.languages:New()
    language.name = "Turque"
    language.uniqueID = "turque"
    language.icon = "icon16/world.png"
...
do
    -- Romanian
    local language = ix.languages:New()
    language.name = "Roumain"
    language.uniqueID = "roumain"
    language.icon = "icon16/world.png"
...
do
    -- Flipino
    local language = ix.languages:New()
    language.name = "Philippin"
    language.uniqueID = "philippin"
    language.icon = "icon16/world.png"
...
do
    -- Irish
    local language = ix.languages:New()
    language.name = "Irlandais"
    language.uniqueID = "irlandais"
...
function PLUGIN:InitializedPlugins()
	for _, v in pairs(ix.languages.stored) do
		if v.name != "Xendarien" and v.name != "Incongru" and v.name != "Impérial" and v.name != "Vortigaunt" then
			for i = 1, 5 do
				local ITEM = ix.item.Register("audiobook_"..i..v.name, nil, false, nil, true)
				ITEM.name = "Apprendre "..v.name.." - Chapitre "..i.." - Un livre audio"
				ITEM.category = "Livres Audio"
				ITEM.model = "models/props_lab/reciever01d.mdl"
                ITEM.description = "Un livre audio qui permet d'apprendre le langage : "..v.name
                if (SERVER) then
                    ITEM.language = v
                end
				...
				RECIPE.name = ""..v.name.." - Chapitre : "..i
				RECIPE.description = "Ecouter ce livre audio vous permettra d'apprendre la langue : "..v.name..". Ceci est le chapitre "..i.." sur 5."
				RECIPE.model = "models/props_lab/reciever01d.mdl"
                RECIPE.category = "Livres Audio"
				RECIPE.hidden = false
