...
PLUGIN.conterminousAgendaMessage = PLUGIN.conterminousAgendaMessage or "Vortigaunt sessiz."
...
function PLUGIN:LoadData()
	PLUGIN.conterminousAgendaMessage = ix.data.Get("VortigauntAgenda") or "Vortigaunt sessiz."
end
...
function PLUGIN:PostPlayerLoadout(client)
	...
	if (background == "Kurtarılmış" or background == "Özgür") then
