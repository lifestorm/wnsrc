...
ix.lang.AddTable("english", {
    optNewCPOverlayEnabled = "Yeni CP Arayüzü'nü Etkinleştir",
    optdNewCPOverlayEnabled = "Eski CP arayüzü ile yeni WN CP arayüzü arasında seçim yapmanıza olanak tanır.",
    optCPGUIEnabled = "CP GUI Etkinleştir",
    optdCPGUIEnabled = "CP GUI'yi etkinleştirmenize veya devre dışı bırakmanıza olanak tanır",
    optCPGUIAlpha = "CP GUI Alfası",
    optdCPGUIAlpha = "CP GUI'nin alfasını (şeffaflık) ayarlayın.",
	optChatterEnabled = "Telsiz Konuşmasını Etkinleştir",
	optChatterInterval = "Telsiz Konuşması Aralığı",
	optdChatterEnabled = "Belirli bir aralıkta CP karakterinizin telsiz konuşması yapmasını açın ve kapatın",
	optdChatterInterval = "Karakterinizin ne sıklıkla telsiz konuşması yapması gerektiği",
	optVoiceToggle = "Oyun İçi Sesini Değiştir",
	optdVoiceToggle = "HL2 veya HLA sesleri arasında geçiş yapın",
	optOTAESP = "OTA ESP Etkinleştir",
	optdOTAESP = "Dost birimleri vurgulayan OTA ESP'yi etkinleştirin veya devre dışı bırakın",
	unitOnDuty = "Birim %s görevde",
	unitOffDuty = "Birim %s görev dışı",
	unitPromotedPTLead = "Birim %s, PT-%d'nin lideri olarak terfi etti",
	ptEnteredArea = "PT-%d, '%s' vektörüne taşındı",
	unitEnteredArea = "Birim %s, '%s' vektörüne giriyor",
	unitCompromised = "UYARI! BİRİM %s ANONİMLİĞİ TEHLİKEDE",
	nexus = "Nexus",
	suitBiosignalMistmach = "%s ELBİSE BİYOSİNYAL UYUŞMAZLIĞI",
	suitDeactivated = "%s elbisesi şimdi devre dışı.",
	suitNoValidFound = "Devre dışı bırakılacak geçerli bir elbise bulunamadı.",
	suitDeactivateNotif = "%s İÇİN ELBİSE DEVRE DIŞI",
	suitDisableTracker = "Bu elbisenin izleyicisi hala aktif! Devre dışı bırakılmazsa, bu elbise giyildiğinde CP'ler UYARILIR.",
	visorInvalidColor = "Bu geçerli bir vizör rengi değil!",
	visorInvalidCode = "Bu geçerli bir vizör kodu değil!",
	optCombineHud = "Combine HUD'u Etkinleştir",
	optdCombineHud = "Combine Heads-Up-Display'in etkin olup olmadığı."
})
