...
ix.config.Add("doorCost", 10, "Le prix d'achat d'une porte.", nil, {
	data = {min = 0, max = 500},
	category = "Portes"
})
ix.config.Add("doorSellRatio", 0.5, "Quelle part du prix de la porte est restituée lors de la vente d'une porte.", nil, {
	data = {min = 0, max = 1.0, decimals = 1},
	category = "Portes"
})
ix.config.Add("doorLockTime", 1, "Le temps qu'il faut pour (dé)verrouiller une porte.", nil, {
