...
ix.config.Add("staminaDrain", 1, "Quantité d'endurance à drainer par tic (tous les quarts de seconde). Ceci est calculé avant la réduction des attributs.", nil, {
	data = {min = 0, max = 10, decimals = 2},
	category = "Personnages"
})

ix.config.Add("staminaRegeneration", 1.75, "Combien d'endurance à récupérer par tic (tous les quarts de seconde).", nil, {
	data = {min = 0, max = 10, decimals = 2},
	category = "Personnages"
})

ix.config.Add("staminaCrouchRegeneration", 2, "Combien d'endurance il faut regagner par tic (tous les quarts de seconde) en étant accroupi.", nil, {
	data = {min = 0, max = 10, decimals = 2},
	category = "Personnages"
})

ix.config.Add("punchStamina", 10, "La quantité d'endurance utilisée par les coups de poing.", nil, {
	data = {min = 0, max = 100},
	category = "Personnages"
})
-- luacheck: pop
