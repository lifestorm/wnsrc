...
ix.lang.AddTable("english", {
	cmdPlyGetInfo = "Wyświetla listę postaci, poszczególne języki, flagi (stałe i tymczasowe) oraz inne info.",
	qolPlyInfo = "Informacje o graczu",
	qolCharacters = "Postacie",
	qolCopiedSteamID = "Skopiowałeś SteamID.",
	qolCopySteamID = "Kopiuj SteamID",
	qolHP = "HP",
	qolArmor = "Pancerz",
	qolPlayerFlags = "Flagi Gracza",
	qolName = "Imię",
	qolLanguages = "Języki",
	qolFlags = "Flagi",
	qolTempFlags = "Flagi Tymczasowe",
	qolGroupName = "Nazwa Grupy",
	qolSeeWhitelists = "Zobacz Whitelisty",
	qolFindItem = "Znajdź przedmiot za pomocą nazwy na mapie/w ekwipunku/w db",
	qolItemsInfo = "Znaleziono przedmioty",
	qolItemsInfoData = "Dane",
	qolItemsInfoInvID = "ID Ekwipunku",
	qolItemsInfoName = "Nazwa przedmiotu",
	qolItemsInfoOwner = "Właściciel",
	qolItemsInfoOrigin = "Pochodzenie",
	qolItemsInfoWPosition = "Pozycja Światowa",
	qolExcludeItems = "Uwzględnij/wyklucz Przedmioty",
	qolSorting = "Sortowanie",
	qolFindItemById = "Znajdź przedmiot za pomocą nazwy na mapie/w ekwipunku/w db używając ID",
})
