...
ix.lang.AddTable("english", {
	...
	optLegsEnabled = "Bacakları aktifleştir",
	optdLegsEnabled = "Aşağı baktığınızda karakterinizin bacaklarını görmeli misiniz?",
	optLegsInVehicle = "Araçlarda bacakları aktifleştir",
	optdLegsInVehicle = "Araçlarda bacaklarınızı görmeli misiniz?"
})
