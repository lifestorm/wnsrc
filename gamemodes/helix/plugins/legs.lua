...
ix.lang.AddTable("english", {
	...
	optLegsEnabled = "Activer les jambes",
	optdLegsEnabled = "Si vous devez voir les jambes de votre personnage lorsque vous regardez vers le bas.",
	optLegsInVehicle = "Activer les jambes dans les véhicules",
	optdLegsInVehicle = "Si vous devez voir les jambes de votre personnage lorsque vous êtes dans un véhicule."
})
