...
function PANEL:Init()
	...
	textStandard(nlrTitle, Color(234, 236, 233, 255), "WNBleedingTitleNoClamp", 78 + padding, string.utf8upper("öldün")) -- 78 icon height

	local nlrText = textPanel:Add("DLabel")
	local nlrText2 = textPanel:Add("DLabel")
	local nlrText3 = textPanel:Add("DLabel")
	textStandard(nlrText, Color(200, 200, 200, 255), "WNBleedingTextNoClamp", -padding, "Yeni yaşam kuralı geçerli, envanteriniz sıfırlandı")
	textStandard(nlrText2, Color(200, 200, 200, 255), "WNBleedingTextNoClamp", -padding, "ve beceri seviyeleriniz azaldı.")

	textStandard(nlrText3, Color(200, 200, 200, 255), "WNBleedingTextBold", -padding + 10, "Bu ekranda son bir /me eylemi gerçekleştirebilirsiniz.")
