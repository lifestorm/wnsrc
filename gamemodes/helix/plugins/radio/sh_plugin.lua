...
ix.lang.AddTable("english", {
	radioFormat = "[%s] %s%s: \"%s\"",
	radioWhisper = " szepcze",
	radioYell = " krzyczy",
	radioScream = " WRZESZCZY",
	radioEaves = " mówi do ",
	radioEavesW = " szepcze do ",
	radioEavesY = " krzyczy do ",
	radioEavesSc = " WRZESZCZY do ",
	radioHis = "jego",
	radioHer = "jej",
	radioRadio = "radio",
	radioStationary = "radio stacjonarne",
	radioYellOver = " krzyczy przez radio",
	radioScreamOver = " WRZESZCZY przez radio",
	radioChannels = "Kanały radiowe",
	quickChannels = "Szybkie kanały",
	radioSpeaking = "Mówienie na",
	radioNone = "brak",
	radioSetChannel = "Kanał został ustawiony na '%s'.",
	radioChannelNotExist = "Ten kanał nie istnieje!",
	radioSubbed = "Zasubskrybowałeś %s do kanału '%s'.",
	radioSubbedT = "Zostałeś zasubskrybowany do kanału '%s' przez %s.",
	radioUnsubbed = "Odsubskrybowałeś %s do '%s' kanału.",
	radioUnsubbedT = "Zostałeś odsubskrybowany z kanału '%s' przez %s.",
	radioNotOn = "To radio nie jest włączone!",
	radioTooFar = "To stacjonarne radio jest za daleko!",
	radioInvalidChannel = "Musisz mówić na prawidłowym kanale radiowym!",
	cmdCharAddRadioChannel = "Subskrybuje gracza do kanału radiowego.",
	cmdCharRemoveRadioChannel = "Odsubskrybowuje gracza do kanału radiowego.",
	cmdSC = "Wybierz kanał, na którym chcesz mówić.",
})
