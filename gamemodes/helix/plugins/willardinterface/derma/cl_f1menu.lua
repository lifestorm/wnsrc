...
function PANEL:Init()
	...
	title:SetText(string.utf8upper("Informacje o postaci i odgrywanej roli"))
	...
	tokens:SetText("Żetony: "..LocalPlayer():GetCharacter():GetMoney())
	...
	description.DoClick = function ( btn )
		Derma_StringRequest(LocalPlayer():Name(), "Ustaw swój opis", LocalPlayer():GetCharacter():GetDescription(), function(desc)
	...
	detDesc.DoClick = function ( btn )
		...
		MenuButtonOptions:AddOption("Areszt (actarrest)", function() ix.command.Send("actarrest") end ) -- Add options to the menu
		MenuButtonOptions:AddOption("Ranny (actinjured)", function() ix.command.Send("actinjured") end )
		MenuButtonOptions:AddOption("Wiwat (actcheer)", function() ix.command.Send("actcheer") end )
		MenuButtonOptions:AddOption("Opieranie się (actlean)", function() ix.command.Send("actlean") end )
		MenuButtonOptions:AddOption("Zadyszka (actpant)", function() ix.command.Send("actpant") end )
		MenuButtonOptions:AddOption("Siedzenie (actsit)", function() ix.command.Send("actsit") end )
		MenuButtonOptions:AddOption("Siedzenie pod Ścianą (actsitwall)", function() ix.command.Send("actsitwall") end )
		MenuButtonOptions:AddOption("Stanie (actstand)", function() ix.command.Send("actstand") end )
		MenuButtonOptions:AddOption("Machanie (actwave)", function() ix.command.Send("actwave") end )
		MenuButtonOptions:AddOption("Okno (actwindow)", function() ix.command.Send("actwindow") end )
		MenuButtonOptions:AddOption("Pisanie (acttype)", function() ix.command.Send("acttype") end )
		MenuButtonOptions:AddOption("Siedzenie na Krześle (actsitchair)", function() ix.command.Send("actsitchair") end)
		MenuButtonOptions:AddOption("Siedzenie pochylone (actsitlean)", function() ix.command.Send("actsitlean") end)
