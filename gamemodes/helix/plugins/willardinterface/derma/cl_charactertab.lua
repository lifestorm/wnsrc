...
function PANEL:Init()
	...
	CreatePart(namePanel, "Imię:", LocalPlayer():GetName(), "name")
	...
	CreatePart(fakeNamePanel, "Fałszywe Imię:", displayFakeName, "fakename", false, editfakenameIcon)
	...
	if geneticDesc then
		CreatePart(geneticDescPanel, "Cechy genetyczne:", geneticDesc, "genetics")
	else
		CreatePart(geneticDescPanel, "Cechy genetyczne:", firstUpper(geneticAge).." | "..firstUpper(geneticHeight).." | "..firstUpper(geneticEyecolor).." Oczy", "genetics")
	end
	-- Description
	...
	CreatePart(descPanel, "Opis:", description, "description", false, editdescIcon)
	...
	CreatePart(factionPanel, "Frakcja:", faction.name, "faction")
	...
	returnToMenuButton:SetText("Wyjdź z postaci i wróć do Menu Głównego")
