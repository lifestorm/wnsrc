...
ix.lang.AddTable("english", {
    cmdCharGiveTempFlags = "Nadaje tymczasowe flagi postaci. Czas jest określony w minutach.",
    cmdCharExtendTempFlags = "Przedłuża (lub skraca) obecne tymczasowe flagi postaci. Wygasną one po określonym czasie.",
    flagTempGiveTitle = "Daj tymczasowe flagi",
    flagTempGive = "%s dał %s na %d minut następujące flagi: '%s'",
    flagAlreadyGiven = "%s posiada już flagi: '%s' lub flagi te nie istnieją.",
    cmdCharTakeTempFlags = "Zabierz tymczasowe flagi od postaci.",
    flagAlreadyTaken = "%s nie posiada flagi '%s'.",
    flagTempTake = "%s zabrał od %s następujące tymczasowe flagi: '%s'",
    cmdCharClearTempFlag = "Zabierz wszystkie tymczasowe flagi od postaci.",
    flagNoClear = "%s nie posiada żadnych tymczasowych flag.",
    flagExpired = "Tymczasowe flagi '%s' postaci %s' wygasły.",
    flagExpireWarn = "Twoje tymczasowe flagi '%s' wygasną za 5 minut."
})
