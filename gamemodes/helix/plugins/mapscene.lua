...
PLUGIN.description = "Ajoute des zones de la carte qui sont visibles lors de la sélection des personnages."
...
if (CLIENT) then
	...
	net.Receive("ixMapSceneSync", function()
		...
		if (!uncompressed) then
			ErrorNoHalt("[Helix] Impossible de décompresser les données de scène de la carte!\n")
			return
		end
