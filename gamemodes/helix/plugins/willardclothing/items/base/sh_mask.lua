...
if (CLIENT) then
	...
	function ITEM:PopulateTooltip(tooltip)
		...
		panel:SetText("Integralność: "..math.Round(self:GetData("filterValue", self.maxFilterValue) * 100 / self.maxFilterValue, 1).."%\n"..
						"Jakość: "..math.Round(self:GetFilterQuality() * 100, 1).."%")
