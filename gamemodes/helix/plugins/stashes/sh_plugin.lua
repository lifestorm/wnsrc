...
ix.lang.AddTable("english", {
    stashesOtherInUse = "Masz już inny schowek w użyciu.",
	stashStartUsing = "Możesz zacząć korzystać z tego schowka.",
	stashOtherInUse = "Masz już w użyciu '%s'.",
	stashHasItems = "Masz przedmioty/żetony w tym schowku."
})
