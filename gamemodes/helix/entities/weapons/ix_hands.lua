...
SWEP.Instructions = [[Clique Gauche : Lancer / Coup de poing
Clique Droit : Toquer / Ramasser
Clique Droit + Souris : Faire pivoter l'objet
Recharger : Déposer
Maintien R : Sortir les poings]]
SWEP.Purpose = "Frapper des choses et frapper aux portes."
SWEP.Drop = false
