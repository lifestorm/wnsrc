...
LANGUAGE = {
	...
	introTextOne = "Willard Network presents",
	...
	GOOCIsDisabled = "Global OOC is disabled on this server.",
	...
	textEdited = "You have edited the text.",
	textNotFound = "The text you are looking for could not be found!",
	...
	rgnLookingAtTemp = "Allow the person you are looking at to recognize you temporary.",
	rgnWhisperTemp = "Allow those in a whispering range to recognize you temporary.",
	rgnTalkTemp = "Allow those in a talking range to recognize you temporary.",
	rgnYellTemp = "Allow those in a yelling range to recognize you temporary.",
	icFormat = "%s says \"%s\"",
	...
	vendorUseCredits = "Vendor should use Credits instead of Chips?",
	vendorNCredits = "%d Credits",
	...
	cmdTextEdit = "Edits the 3D text block that you are looking at.",
	...
	optEnablePrivateMessageSound = "Enable private message sound",
	optdEnablePrivateMessageSound = "Whether a sound should play when you receive a private message.",

	cmdTeleporterModel = "Sets the model of the teleporter you're aiming at.",
	cmdTeleporterResetLink = "Resets the link(s) of the teleporter you're aiming at.",
	cmdTeleporterWarpSound = "Sets the sound upon warping through a teleporter.",
	cmdTeleporterResetWarpSound = "Resets the teleporter's warp sound.",
	cmdTeleporterModificationInterface = "Shows the teleporters modification interface.",
	invalidTeleporter = "Invalid teleporter",
	noAccessCommandTeleporter = "You do not have access to this command!",
	linkResetSuccessful = "Link resetted successfully.",
	warpSoundSetSuccessful = "Warp Sound setted successfully.",
	warpResetSuccessful = "Warp Sound resetted successfully.",
	noAccessFunctionality = "You do not have access to this functionality!",
	invalidSelectedTeleporter = "The selected teleporter is invalid.",
	teleporterBlocked = "The destination of this teleporter is blocked by something.",
	teleporterSelectionTimeout = "Selection resetted. (Timed out)",
}