...
if (SERVER) then
	...
	function ENT:OnOptionSelected(client, option, data)
		if (option == "Ustaw poziom 1 dostępu") then
			self.accessLevel = 1

			client:Notify("Ustawiono poziom 1 dostępu do tej blokady.")
		elseif (option == "Ustaw poziom 2 dostępu") then
			self.accessLevel = 2

			client:Notify("Ustawiono poziom 2 dostępu do tej blokady.")
		elseif (option == "Ustaw poziom 3 dostępu") then
			self.accessLevel = 3

			client:Notify("Ustawiono poziom 3 dostępu do tej blokady.")
		elseif (option == "Ustaw poziom 4 dostępu") then
			self.accessLevel = 4

			client:Notify("Ustawiono poziom 4 dostępu do tej blokady.")
		elseif (option == "Ustaw poziom 5 dostępu") then
			self.accessLevel = 5

			client:Notify("Ustawiono poziom 5 dostępu do tej blokady.")
		end
	end
