...
function FACTION:OnCharacterCreated(client, character)
	...
	if (background == "Biotyk" or background == "Uwolniony" or background == "Kolaborator") then
		timer.Simple(5, function()
			if (background == "Uwolniony") then
			...
			elseif (background == "Kolaborator") then
				client:Give("ix_vshield")
				client:Give("ix_nightvision")
				client:Give("ix_vortbeam")
				client:Give("ix_vortheal")
		...
		if background == "Kolaborator" then
