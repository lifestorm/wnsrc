...
FACTION.description = "Zwykły ludzki obywatel zniewolony przez Kombinat."
...
function FACTION:OnCharacterCreated(client, character)
	...
	if (background == "Relokowany Obywatel") then
		inventory:Add("suitcase", 1)
		inventory:Add("flashlight", 1)
		inventory:Add("armband_grey", 1)
	elseif (background == "Miejscowy Obywatel") then
		inventory:Add("flashlight", 1)
		inventory:Add("armband_grey", 1)
	elseif (background == "Wyrzutek") then
