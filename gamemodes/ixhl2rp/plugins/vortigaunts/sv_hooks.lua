...
PLUGIN.conterminousAgendaMessage = PLUGIN.conterminousAgendaMessage or "Vortigaunt milczy."
...
function PLUGIN:LoadData()
	PLUGIN.conterminousAgendaMessage = ix.data.Get("VortigauntAgenda") or "Vortigaunt milczy."
end
...
function PLUGIN:PostPlayerLoadout(client)
	...
	if (background == "Uwolniony" or background == "Wolny") then
