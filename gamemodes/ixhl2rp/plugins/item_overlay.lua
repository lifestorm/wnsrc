...
ix.lang.AddTable("english", {
	optEnableOverlay = "Włącz nakładkę przedmiotów",
	optdEnableOverlay = "Czy przedmioty mogą wyświetlać nakładkę na ekranie.",
	optOverlayAlpha = "Alfa nakładki",
	optdOverlayAlpha = "Wartość alfa (przezroczystość) nakładki."
})
