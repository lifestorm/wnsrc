...
ITEM.name = "Lekki mundur funkcjonariusza"
ITEM.model = Model("models/wn7new/metropolice/cpuniform.mdl")
ITEM.description = "Zgrabny i schludny mundur przeznaczony do użytku przez Civil Protection. Zawiera kamizelkę kevlarową Poziomu-2, doocieplane oliwkowe spodnie, pas użytkowy z dwufazowej stali oraz buty wojskowe ze stalkapą."
