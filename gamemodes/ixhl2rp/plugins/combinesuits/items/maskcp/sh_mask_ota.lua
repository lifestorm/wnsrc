...
ITEM.name = "Maska OTA"
ITEM.description = "Zapewnia anonimowość i ochronę przeciwko szkodliwym gazom."
...
ITEM.colorAppendix = {["blue"] = "Atrapa przedmiotu, aby maska przeciwgazowa i maska Kombinatu działały."}