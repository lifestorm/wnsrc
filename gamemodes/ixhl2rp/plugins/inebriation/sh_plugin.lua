...
ix.inebriation.types = {
    ["SOBER"] = {
        name = "Trzeźwy",
        description = "Jesteś całkowicie trzeźwy.",
        threshold = 0
    },
    ["SLIGHTLY_DRUNK"] = {
        name = "Nieco pijany",
        description = "Czujesz się trochę podchmielony.",
        threshold = 10
    },
    ["DRUNK"] = {
        name = "Pijany",
        description = "Czujesz się pijany.",
        threshold = 40
    },
    ["VERY_DRUNK"] = {
        name = "Bardzo pijany",
        description = "Czujesz się bardzo pijany.",
        threshold = 70
    },
    ["WASTED"] = {
        name = "Nawalony",
        description = "Jesteś kompletnie nawalony.",
        threshold = 90
    }
}
...
ix.inebriation.grades = {
    ["LOW"] = {
        appendText = "Jest to napój niskiej jakości.",
        damage = 15
    },
    ["MEDIUM"] = {
        appendText = "Jest to napój średniej jakości.",
        damage = 5
    },
    ["HIGH"] = {
        appendText = "Jest to napój wysokiej jakości.",
        damage = 0
    }
}
