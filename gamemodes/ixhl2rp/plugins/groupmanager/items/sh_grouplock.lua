...
ITEM.name = "Zamek grupowy"
ITEM.description = "Metalowe urządzenie montowane na drzwiach, potrzebujesz grupy aby działał."
...
ITEM.functions.Place = {
	OnRun = function(itemTable)
		...
		if !client.CantPlace then
			...
			client:NotifyLocalized("Musisz chwilę poczekać, zanim będziesz mógł to postawić!")
			return false
		end
	end
}
