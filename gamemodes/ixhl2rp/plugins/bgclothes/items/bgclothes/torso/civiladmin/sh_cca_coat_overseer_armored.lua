...
ITEM.name = "Overseer - opancerzony"
ITEM.description = "Ciemnobordowy prochowiec Overseera, reprezentujący jego silny autorytet. Jest to opancerzony wariant stroju."
...
ITEM.proxy = {
    ...
    TorsoColor = Vector(65 / 255, 0 / 255, 0 / 255)
}
