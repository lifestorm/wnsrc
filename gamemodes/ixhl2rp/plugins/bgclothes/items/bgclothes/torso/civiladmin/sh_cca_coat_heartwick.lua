...
ITEM.name = "Płaszcz Heartwicka"
ITEM.description = "Płaszcz zimowy zaprojektowany osobiście dla administratora Heartwicka."
...
ITEM.proxy = {
ShirtColor = Vector(249 / 255, 253 / 255, 242 / 255),
TorsoColor = Vector(31 / 255, 35 / 255, 51 / 255)
}
ITEM.bodyGroups	=	{
		torso	=	35
}
