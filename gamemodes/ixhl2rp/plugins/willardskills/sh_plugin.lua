...
ix.lang.AddTable("english", {
	ffLostInitiative = "Straciłeś inicjatywę! Zagrasz jedną turę później.",
	ffGainedInitiative = "Zyskałeś inicjatywę! Zagrasz jedną turę wcześniej.",
	levelGained = "Zdobyłeś poziom umiejętności %s do poziomu %d.",
	levelPossible = "Możesz awansować w umiejętności %s do poziomu %d.",
	cmdCharSkillSet = "Ustawia określony poziom postaci w danej umiejętności.",
	cmdCharSkillAdd = "Dodaje określoną liczbę poziomów do umiejętności postaci.",
	cmdCharSkillReset = "Resetuje umiejętność postaci z powrotem do 0.",
	cmdCharSkillResetAll = "Resetuje wszystkie umiejętności postaci do 0.",
	cmdRefundSkills = "Przywraca wszystkie poziomy umiejętności utracone przez gracza po jego ostatniej śmierci.",
	assembleCant = "Musisz poczekać, zanim będziesz mógł to złożyć!",
	assembleMissingRequirement = "Do złożenia tego przedmiotu potrzebny jest %s!",
	assembleSuccess = "Złożyłeś %s.",
	assembleNoSpace = "Do złożenia tego przedmiotu potrzebne jest %sx%s miejsca w ekwipunku!"
})
