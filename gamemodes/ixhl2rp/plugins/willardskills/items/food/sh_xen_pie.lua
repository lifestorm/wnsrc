...
ITEM.name = "Ciasto Xen"
ITEM.description = "Przygoda z Ciastem Xen to jak wchodzenie na nieznany szczyt - nigdy nie wiesz, co cię tam czeka, ale zawsze warto spróbować. Trzeba mieć w sobie odrobinę odwagi, żeby go spróbować."
ITEM.category = "Xen"
