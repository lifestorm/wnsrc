...
ix.lang.AddTable("english", {
    optShowAutomaticActionsInChat = "Wyświetl automatyczne akcje na czacie",
    optdShowAutomaticActionsInChat = "Czy mają być wyświetlane automatyczne wiadomości czatu przy niektórych akcjach.",
...
ix.autochat.types = {
    ["WEAPON_RAISE_FISTS"] = {
        text = {
            " unosi pięści, gotów walczyć.",
            " unosi pięści, szykując się do bijatyki.",
            " ustawia się w pozycji pionowej i unosi pięści, szykując się do walki."
        },
    ...
    ["WEAPON_RAISE_MELEE"] = {
        text = " unosi swoją broń.",
        icon = ix.util.GetMaterial("willardnetworks/chat/gun_orange.png"),
        color = Color(255, 172, 95),
        colorAlt = Color(255, 207, 95)
    },
    ["WEAPON_RAISE_GUN"] = {
        text = " unosi swoją broń i nią celuje.",
        icon = ix.util.GetMaterial("willardnetworks/chat/gun_orange.png"),
        color = Color(255, 172, 95),
        colorAlt = Color(255, 207, 95)
    },
    ["WEAPON_FIRE_START"] = {
        text = {
            " naciska spust, wystrzeliwując pocisk do swojego celu.",
            " pociąga za sput, wystrzeliwując pociski w zamierzony cel.",
            " strzela ze swojej broni w kierunku zamierzonego celu.",
            " błyskawicznie naciska sput broni, wysyłając salwę ostrej amunicji w kierunku obranego celu."
        },
    ...
    ["WEAPON_MELEE_START"] = {
        text = { " zaczyna atakować swój cel trzymaną w rękach bronią." },
        icon = ix.util.GetMaterial("willardnetworks/chat/gun_red.png"),
        color = Color(193, 63, 63),
        colorAlt = Color(255, 88, 58)
    },
    ...
    ["ENTER_BLEEDOUT"] = {
        text = {
            " odnosząc poważne obrażenia zaczyna wykrwawiać się.",
            " mając ciężkie rany bezwładnie pada na ziemię.",
            " upada na ziemię, jest ciężko ranny i wykrwawia się.",
            " będąc krytycznie ranny upada na ziemię, krwawiąc.",
            " w wyniku odniesionych obrażeń upada na ziemię."
        },
    },
    ["DRUNK_FALL_OVER"] = {
        text = {
            " opada na ziemię, chłodne podłoże nieoczekiwanie stało się miejscem jego odpoczynku..",
            " chwieje się w bok i pijackim amoku upada na ziemię..",
            " niezgrabnie kołysze się, wtem w stanie upojeniu alkoholowego upada prosto twarzą na ziemię.",
            " rusza zygzakiem do przodu, po czym w pijanym kroku ląduje twarzą na ziemi.",
            " chybocze na boki, by następnie bezbłędnie wykonać lądowanie twarzą o podłogę.",
            " przechyla się do przodu, po czym po alkoholowym popisie akrobatycznym spektakularnie przewraca się twarzą na ziemię."
        },
    },
    ["CONTAINER_OPEN"] = { text = " otwiera pojemnik 'X'." },
    ["MEDICAL_BANDAGE"] = {
        text = {
            " opatruje bandażem swoje krwawiące rany.",
            " owija bandażem swoje krwawiące rany.",
            " bandażuje swoje rany.",
        }
    },
    ["DRUG_INJECT"] = { text = " wstrzykuje sobie narkotyk." },
    ["SEARCH_TRASH"] = { text = " przeszukuje worki na śmieci w poszukiwaniu czegoś interesującego."},
}
