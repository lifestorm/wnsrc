...
function PLUGIN:RemoveBag(client, target)
	target:SetAction("Worek jest zdejmowany z twojej głowy", 3)
	target:SetNetVar("unbagging", true)

	client:SetAction("Zdejmujesz worek", 3)
...
function PLUGIN:EnterDrag(client, target)
	...
	client:Notify("Ciągniesz teraz osobę")
...
function PLUGIN:ExitDrag(id, client, target)
	self.Actors[id] = nil
	client:Notify("Już nie ciągniesz osoby")
