...
ITEM.width = 1
ITEM.height = 1
ITEM.description = "Reżimowy telewizor przeznaczony do wyświetlania programów propagandowych."
ITEM.category = "misc"
...
ITEM.functions.Place = {
	OnRun = function(itemTable)
		...
		elseif client.CantPlace then
			client:NotifyLocalized("Nie możesz tego teraz umieścić!")
			return false
		else
			client:NotifyLocalized("Nie możesz umieścić go tak daleko!")
			return false
		end
	end
}