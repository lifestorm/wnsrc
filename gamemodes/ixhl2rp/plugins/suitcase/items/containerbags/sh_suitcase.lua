...
ITEM.name = "Walizka"
ITEM.description = "Niewielka walizka gotowa przenieść wszystko, czego nie pomieścisz w rękach."
				...
				if v.name == self.name then
					if newInventory:GetOwner() then
						if v.name == "Walizka" then
							newInventory:GetOwner():NotifyLocalized("Możesz nosić tylko jedną walizkę!!")
						else
							newInventory:GetOwner():NotifyLocalized("Nie możesz nosić więcej niż jednej takiej torby!")
						end
					end
