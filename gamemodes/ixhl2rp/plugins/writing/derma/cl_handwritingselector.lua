...
function PANEL:Init()
	...
	self:CreateFontButton(buttonBox, "BookCaveat", "Caveat")
	self:CreateFontButton(buttonBox, "BookKalam", "Kalam")
	self:CreateFontButton(buttonBox, "BookAmita", "Amita")
	self:CreateFontButton(buttonBox, "BookCourgette", "Courgette")
	self:CreateFontButton(buttonBox, "BookDancing", "Dancing")
	self:CreateFontButton(buttonBox, "BookTimes", "Times")
	self:CreateFontButton(buttonBox, "BookCourier", "Courier")
end
...
function PANEL:CreateFontButton(buttonBox, font, text)
    ...
    button.DoClick = function()
        ...
        LocalPlayer():NotifyLocalized("Pomyślnie wybrałeś swoje pismo odręczne jako "..text)
        self:Remove()
    end
end
