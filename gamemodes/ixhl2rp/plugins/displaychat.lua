...
ix.lang.AddTable("english", {
	optChatDisplayEnabled = "Włącz wyświetlanie komunikatu czatowania",
	optdChatDisplayEnabled = "Czy tekst powinien pojawiać się nad głowami postaci, gdy mówią.",
	optChatDisplayLength = "Maks długość wyświetlania czatu",
	optdChatDisplayLength = "Maksymalna długość wyświetlania komunikatu czatowania nad głową.",
	optChatDisplayDurationPerSymbol = "Czas wyświetlania jednego znaku tekstowego",
	optdChatDisplayDurationPerSymbol = "Ile sekund powinien być wyświetlany czat na każdy znak tekstu.",
	optChatDisplayOwnDisplayEnabled = "Wyświetlanie własnych wiadomości",
	optdChatDisplayOwnDisplayEnabled = "Czy własne wiadomości powinny wyświetlać się nad Twoją głową.",
	staticCharActionSet = "Ustaw statyczną akcję postaci",
	staticCharActionRemove = "Usuń statyczną akcję swojej postaci.",
	staticCharActionSetTooLong = "Statyczna akcja postaci nie może być dłuższa niż 255 znaków!",
	staticCharActionSetNoAfk =  "Nie używaj tego komendy, aby opisać siebie jako AFK."
})
