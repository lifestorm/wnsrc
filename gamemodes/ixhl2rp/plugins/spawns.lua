...
PLUGIN.backgrounds = {"relokowany obywatel", "miejscowy obywatel", "zwolennik", "wyrzutek", "biotyk", "kolaborator", "uwolniony", "wolny", "pracownik", "lekarz"}

ix.lang.AddTable("english", {
	optEspShowSpawns = "Włącz ESP Spawnów",
	optdEspShowSpawns = "Pokaż pozycje spawnów w ESP administratora."
})
