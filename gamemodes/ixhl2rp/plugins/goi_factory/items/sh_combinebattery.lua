...
ITEM.name = "Akumulator Kombinatu"
ITEM.model = "models/willardnetworks/gearsofindustry/wn_battery.mdl"
ITEM.category = "Combine"
ITEM.description = "Niewielki Akumulator Kombinatu wielokrotnego ładowania. Posiada z tyłu port ładowania i kilka portów wyświetlających poziom naładowania."
ITEM.iconCam = {
...
function ITEM:PopulateTooltip(tooltip)
	...
	chargePnl:SetText("Ładunek: " .. (charge * 10) .. "%")
