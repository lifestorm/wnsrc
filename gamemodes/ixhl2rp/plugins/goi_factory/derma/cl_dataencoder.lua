...
function PANEL:BuildEncodingPanel()
	...
	function()
		...
		upperLabel:SetText(string.utf8upper("skanowanie i enkodowanie......"))
		...
		bottomLabel:SetText(string.utf8upper("nie wkładaj rąk do komory terminala"))
...
function PANEL:RequestDisc()
	...
	function()
		...
		self.bottomLabel:SetText(string.utf8upper("wymagany jest pusty dysk danych"))
		...
		self.upperLabel:SetText(string.utf8upper("[WŁÓŻ PUSTY DYSK DANYCH, ABY KONTYNUOWAĆ // CENTRUM DANYCH ENKODOWANIA]"))
...
function PANEL:BuildInteraction(parent)
	if self:GetDisc() != "" then
		...
		errorLabel:SetText(string.utf8upper("włożony dysk ma już \n zakodowany przedmiot"))
	...
	bottomLabel:SetText(string.utf8upper("włóż pożądany przedmiot do terminala i potwierdź skanowanie"))
	bottomLabel:SetTextColor(defClr)
	...
	confirmLabel:SetText(string.utf8upper("kontynuować enkodowanie?"))
	...
	CreateButton(confirmButton, "POTWIERDŹ SKANOWANIE", "buttonnoarrow.png", "WNTerminalMediumText", 5)
