...
function PANEL:CreateNextPrev(parent, buttonFont, buttonAlign, prevFunc, nextFunc, bHorizontal, manualWidth)
	...
	CreateButton(nextButton, "następne", buttonFont, buttonAlign)
	nextButton.DoClick = nextFunc

	local prevButton = parent:Add("DButton")
	CreateButton(prevButton, "poprzednie", buttonFont, buttonAlign)
...
function PANEL:FillDiscInteraction(parent)
	...
	CreateButton(fabButton, "SYNTEZUJ", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	fabButton:Dock(FILL)
	...
	CreateButton(fabButtonMass, "SYNTEZUJ MASOWO", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	...
	resinLabel:SetText(string.utf8upper("wymagana ilość żywicy: " .. ix.fabrication:Get(itemID).mainMaterialCost))
...
function PANEL:CreateFabricating()
	...
	function()
		...
		CreateButton(returnButton, "POWRÓT", "buttonnoarrow.png", "WNTerminalLargeText", 5)
		...
		if (!self:GetDisc() or self:GetDisc() == "") then
			...
			errorLabel:SetText(string.utf8upper("zakodowane dane\nwymagany dysk!"))
		...
		upperLabel:SetText(string.utf8upper("zakodowane informacje"))
...
function PANEL:FillRecycleInteraction(parent)
	...
	fcLabel:SetText(string.utf8upper("sterowanie fabrykatora"))
	...
	wLabel:SetText(string.utf8upper("[nie wkładaj rąk do komory fabrykatora]"))
	...
	CreateButton(toggleDepot, "otwórz\n/\nzamknij", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	...
	CreateButton(recycle, "recykluj", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	recycle:Dock(FILL)
...
function PANEL:CreateRecycling()
	...
	function()
		...
		upperLabel:SetContentAlignment(5)
		upperLabel:SetFont("WNTerminalLargeText")
		upperLabel:SetText(string.utf8upper("recykling"))
		upperLabel:SetTextColor(defClr)
		upperLabel:SetAlpha(0)
		upperLabel:SizeToContents()
...
function PANEL:CreateOptionButtons(parent)
	...
	CreateButton(fabricate, "FABRYKUJ", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	fabricate:Dock(LEFT)
	...
	CreateButton(bioprocessing, "BIOPROCESUJ", "buttonnoarrow.png", "WNTerminalMediumText", 5)
...
function PANEL:FillBioPanel(parent)
	...
	CreateButton(bioButton, "SYNTEZUJ", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	bioButton:Dock(FILL)
	...
	CreateButton(bioButtonMass, "SYNTEZUJ MASOWO", "buttonnoarrow.png", "WNTerminalMediumText", 5)
	...
	self.itemIcon.OnItemChanged = function(s)
		...
		itemMats:SetText(string.utf8upper("koszt biopiasty: " .. s.fab.mainMaterialCost))
...
function PANEL:CreateBioprocess()
	...
	function()
		...
		upperLabel:SetContentAlignment(5)
		upperLabel:SetFont("WNTerminalLargeText")
		upperLabel:SetText(string.utf8upper("bioprocesowanie"))
		upperLabel:SetTextColor(defClr)
		upperLabel:SetAlpha(0)
		upperLabel:SizeToContents()
